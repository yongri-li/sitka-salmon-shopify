...
const ArticleMain = forwardRef(({contentType, fields, product, showNav = false, blogGlobalSettings}, ref) => {
  ...
  return (
    <div ref={ref} className={classes['article-main']}>
      ...
      <div className={classes['article-main__wrapper']}>
        ...
        {sidebar && <ArticleSidebar fields={sidebar} blogGlobalSettings={blogGlobalSettings} />}
      </div>
    </div>
  )
})
